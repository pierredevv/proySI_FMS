            ...
            <div className="grid gap-4">
              ...
              {bulkResult && (
                <div className="rounded-md bg-muted p-3 text-sm space-y-1">
                  ...
                  <p>Nuevas deudas: <span className="font-semibold">{bulkResult.resumen.nuevas_deudas}</span></p>
                  <p>Ya existían: <span className="font-semibold">{bulkResult.resumen.ya_existentes}</span></p>
                  <p>Sin arancel configurado: <span className="font-semibold">{bulkResult.resumen.sin_arancel_configurado}</span></p>
                  <p>Total procesados: <span className="font-semibold">{bulkResult.resumen.total_procesados}</span></p>
                </div>
              )}
            </div>
            <DialogFooter>
              <Button onClick={generateBulk} disabled={bulkLoading} className="gap-2">
                <Layers className="h-4 w-4" />
